...
app.DEFINE_string(
  "devtype", "all", "Use any OpenCL device of type: {all,cpu,gpu}."
)
...
app.DEFINE_string(
  "lsize", "32,1,1", "Comma separated NDRange for local (workgroup) size."
)
app.DEFINE_integer(
  "timeout", -1, "Error if execution has not completed after this many seconds."
)
...
app.DEFINE_boolean(
  "debug", False, "Enable more verbose OpenCL compilation and execution."
)
app.DEFINE_boolean(
  "binary", False, "Print outputs as a pickled binary numpy array."
)
